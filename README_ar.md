...
افتح أدوات المطور في المتصفح (عادةً بالضغط على **F12**) ثم نفِّذ الأمر:

```javascript
localStorage.setItem('jsonbin_api_key', 'مفتاحك')
```

بعد ذلك أعد تحميل الصفحة ليتمكن التطبيق من قراءة المفتاح.
