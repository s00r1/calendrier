...
6. In the **SQL Editor**, copy the block below to create the `admin_configs` table, enable RLS and add the `anon_full_access` policy:
...
3. Repeat the operation for the `admin_configs` table using the SQL block above.
